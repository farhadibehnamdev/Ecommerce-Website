      ...
      <Combobox as="div" value={selectedPerson} onChange={setSelectedPerson}>
        ...
        <div className="relative  w-full block">
          <Combobox.Input
            ...
            className="w-full block rounded-md border-0 bg-white py-1.5 pl-7 text-zinc-900 shadow-sm ring-1 ring-inset ring-zinc-300 focus:ring-1 focus:ring-inset focus:ring-zinc-600 sm:text-sm sm:leading-6"
          ...
          {filteredPeople.length > 0 && (
            <Combobox.Options className="absolute z-10 mt-1 max-h-56 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-zinc-400 ring-opacity-5 focus:outline-none sm:text-sm">
