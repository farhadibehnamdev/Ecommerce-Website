      ...
      {!emailVerificationToken ? (
        <div className="text-center ring-1 rounded-10 ring-dark p-10">
          <p className="text-base flex justify-center font-semibold text-indigo-600">
            <TbFaceIdError className="h-16 w-16 mb-4 text-dark" />
          </p>

          <p className=" mb-5 text-dark font-jostBodyBold text-2xl">
            Please click on the button below to send the verification email.
          </p>
          <button
            onClick={handleSubmitVerification}
            type="button"
            className="rounded-md gap-2 bg-dark px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-white hover:ring-1 hover:ring-dark hover:text-dark focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-dark"
          >
