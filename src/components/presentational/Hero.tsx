  ...
  return (
    <div className="relative bg-dark5  max-w-[1380px] md:h-full  lg:w-full md:w-full sm:w-full">
      <div className=" grid lg:grid-cols-12  lg:gap-x-8 lg:px-8 md:grid-cols-2  md:px-10">
        <div className="ml-0 pb-24 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pb-56 lg:pt-48 xl:col-span-6 lg:mx-auto w-fit xs:mx-auto sm:mx-auto">
          <div className="relative  max-w-2xl lg:mx-0 ">
            <p className="mt-6 text-dark xs:text-center sm:text-center lg:text-left font-400 font-jostBodyRegular break-words text-3xl sm:mx-sm:mx-auto">
              Classic Exclusive
            </p>
