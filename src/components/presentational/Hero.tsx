...
const Hero = function () {
  return (
    <div className="relative bg-dark5  max-w-[1380px]  lg:w-full md:w-full sm:w-full">
      <div className=" grid lg:grid-cols-12  lg:gap-x-8 lg:px-8 md:grid-cols-2  md:px-10">
        ...
        <div className="relative lg:col-span-5 lg:-mr-8 xl:absolute xl:inset-0 xl:left-1/2 xl:ml-0 ">
          <Image
            width={593}
            height={884}
            className="aspect-[3/2] w-auto bg-gray-50 object-cover lg:absolute lg:inset-0 lg:aspect-auto lg:h-full sm:aspect-auto md:bottom-0"
