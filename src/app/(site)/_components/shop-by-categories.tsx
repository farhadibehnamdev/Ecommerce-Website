...
const ShopByCategories = function () {
  return (
    <div className="mx-auto lg:max-w-7xl  mt-24 mb-36 ">
      <div className="flex justify-between items-center mb-12">
        <h3 className="text-dark xl:text-[40px] sm:text-[20px] flex justify-center items-center ">
          Shop By Categories
        </h3>
        <div className="flex justify-center  gap-5">
          <button className="bg-dark5 w-4 h-4 p-5 mx-auto rounded-10 flex justify-center items-center hover:bg-dark ">
      ...
      <div className="grid  lg:grid-flow-col  gap-x-[4.5rem] md:grid-cols-2 md:justify-center md:justify-items-center">
        <div className="w-[262px] h-[360px] flex item-center justify-center bg-dark5 overflow-hidden relative ">
